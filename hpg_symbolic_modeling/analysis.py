...
def build_hpg_for_library(file_path, analyze=True, build=True, activate= False, general=True):
...
def run_analyzer(file_path, analyze=True, build=True,  activate= False, query=True, general=True):
	...
	build_hpg_for_library(file_path, analyze=analyze, build=build, activate=activate, general=general)
	if query:
