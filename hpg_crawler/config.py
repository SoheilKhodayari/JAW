...
# directory to output the crawling data: currently in hpg-construction/outputs
OUTPUT_DATA_DIRECTORY = os.path.join(os.path.join(os.path.dirname(CRAWLER_BASE_DIR), "hpg_construction"), "outputs")
