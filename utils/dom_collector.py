...
"""
	...
	Description:
	------------
	JS Stream Collector Module: collect and process JS from a web page
...
def get_dynamic_data(siteId, url, driver= None, close_conn= True, internal_only=False):
	...
	# Note: 
	# We skip analyzing JS libriares embedded in the pages
	...
	siteConfig = sitesMapConfig.SITES_MAP[siteId]
	domain = siteConfig[2].rstrip('/')
