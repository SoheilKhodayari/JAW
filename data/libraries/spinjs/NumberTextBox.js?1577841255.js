...
define("dijit/form/NumberTextBox", ["dojo/_base/declare", "dojo/_base/lang", "dojo/i18n", "dojo/string", "dojo/number", "./RangeBoundTextBox"], function(_1, _2, _3, _4, _5, _6) {
    var _7 = function(_8) {
        var _8 = _8 || {},
            _9 = _3.getLocalization("dojo.cldr", "number", _3.normalizeLocale(_8.locale)),
            _a = _8.pattern ? _8.pattern : _9[(_8.type || "decimal") + "Format"];
        var _b;
    ...
    var _c = _1("dijit.form.NumberTextBoxMixin", null, {
        pattern: function(_d) {
        ...
        _formatter: _5.format,
        _regExpGenerator: _5.regexp,
        _decimalInfo: _7(),
        ...
        _setBlurValue: function() {
            var val = _2.hitch(_2.delegate(this, {
                focused: true
            }), "get")("value");
        ...
        _isValidSubset: function() {
            var _20 = (typeof this.constraints.min == "number"),
                _21 = (typeof this.constraints.max == "number"),
                _22 = this.get("value");
            ...
            var _23 = _22 | 0,
                _24 = _22 < 0,
                _25 = this.textbox.value.indexOf(this._decimalInfo.sep) != -1,
                _26 = this.maxLength || 20,
                _27 = _26 - this.textbox.value.length,
                _28 = _25 ? this.textbox.value.split(this._decimalInfo.sep)[1].replace(/[^0-9]/g, "") : "";
            var _29 = _25 ? _23 + "." + _28 : _23 + "";
            var _2a = _4.rep("9", _27),
                _2b = _22,
                _2c = _22;
            if (_24) {
                _2b = Number(_29 + _2a);
    ...
    var _2d = _1("dijit.form.NumberTextBox", [_6, _c], {
